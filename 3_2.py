...
if __name__ == "__main__":
    ...
    # miejscu, nie zwraca nowej wartosci

    x, y = 1, 2, 3
    # nie wiadomo którą wartośc chcieliśmy przyporządkować do którejś zmiennej(ValueError), za mało zmiennych
    ...
    X = "abc"
    X.append("d")
    # metodę append możemy wykonywać tylko na listach a X jest stringiem
